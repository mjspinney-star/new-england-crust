...
gear:
  - name: "Ninja Woodfire 8-in-1 Outdoor Oven (OO101)"
    url: "https://www.amazon.com/Ninja-Woodfire-Technology-terracotta-OO101/dp/B0C6BQVDX3"
    affiliateId: "ninja-woodfire-oven"
  - name: "Microplane fine grater"
    url: "https://amzn.to/4wlcEf7"
    note: "Garlic for the ranch base, Parm for the top — same tool."
    affiliateId: "microplane-grater"
  - name: "Squeeze bottle"
    url: "https://amzn.to/4guXrDq"
    note: "For the finishing ranch drizzle in step 5."
    affiliateId: "squeeze-bottles"
  - name: "La Baleine fine sea salt"
...
**On the mozzarella:** Low-moisture here, not fresh. Fresh mozzarella releases too much water for a pie that already has a creamy base — you'll get a soggy center. Part-skim low-moisture shredded mozzarella is the right call.

**On the chicken:** Rotisserie chicken from a grocery store works as well as anything we've tried from scratch. The bake is short and the chicken isn't raw, so what matters is that it's well-seasoned going on. Pull it from the bone while still warm and season with salt.
