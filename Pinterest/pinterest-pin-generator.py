...
PINS = [
    ...
    },
    {
        ...
        "subhead":        "We bought a $25 cheat sheet and a cleaning kit we never opened — here's what we'd skip instead.",
        "layout":         "split",
        "output":         "outputs/NEC-accessories-pin12.png",
    },
    {
        "photo_path":     "NinjaWoodfireHero.jpeg",
        "category":       "Gear Guide",
        "headline":       "Months In — Here's What We'd Tell a New Ninja Woodfire Owner",
        "subhead":        "Months of pizza, pulled pork, and dehydrated apple chips later — here's our honest gear verdict.",
        "layout":         "split",
        "output":         "outputs/NEC-accessories-pin13.png",
    },
    {
        "photo_path":     "pesto-pizza-spreading-sauce-pin-1000x1500.jpg",
        "category":       "Recipe",
